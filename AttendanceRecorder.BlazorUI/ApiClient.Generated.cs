...
namespace AttendanceRecorder.Client
{
    ...
    #pragma warning restore CS8618 // Non-nullable field must contain a non-null value when exiting constructor. Consider declaring as nullable.
        ...
        public virtual System.Threading.Tasks.Task<System.Collections.Generic.ICollection<System.DateTimeOffset>> GetDaysAsync(int year, int week)
        {
            return GetDaysAsync(year, week, System.Threading.CancellationToken.None);
        }

        /// <param name="cancellationToken">A cancellation token that can be used by other objects or threads to receive notice of cancellation.</param>
        /// <returns>OK</returns>
        /// <exception cref="ApiException">A server side error occurred.</exception>
        public virtual async System.Threading.Tasks.Task<System.Collections.Generic.ICollection<System.DateTimeOffset>> GetDaysAsync(int year, int week, System.Threading.CancellationToken cancellationToken)
        {
            if (year == null)
                throw new System.ArgumentNullException("year");

            if (week == null)
                throw new System.ArgumentNullException("week");
            ...
            try
            {
                using (var request_ = new System.Net.Http.HttpRequestMessage())
                {
                    ...
                    // Operation Path: "api/years/{year}/weeks/{week}"
                    urlBuilder_.Append("api/years/");
                    urlBuilder_.Append(System.Uri.EscapeDataString(ConvertToString(year, System.Globalization.CultureInfo.InvariantCulture)));
                    urlBuilder_.Append("/weeks/");
                    urlBuilder_.Append(System.Uri.EscapeDataString(ConvertToString(week, System.Globalization.CultureInfo.InvariantCulture)));
        ...
        public virtual async System.Threading.Tasks.Task<System.Collections.Generic.ICollection<int>> GetWeeksAsync(int year, System.Threading.CancellationToken cancellationToken)
        {
            ...
            try
            {
                using (var request_ = new System.Net.Http.HttpRequestMessage())
                {
                    ...
                    var urlBuilder_ = new System.Text.StringBuilder();
                    if (!string.IsNullOrEmpty(_baseUrl)) urlBuilder_.Append(_baseUrl);
                    // Operation Path: "api/years/{year}/weeks"
                    urlBuilder_.Append("api/years/");
                    urlBuilder_.Append(System.Uri.EscapeDataString(ConvertToString(year, System.Globalization.CultureInfo.InvariantCulture)));
                    urlBuilder_.Append("/weeks");
        ...
        /// <returns>OK</returns>
        /// <exception cref="ApiException">A server side error occurred.</exception>
        public virtual System.Threading.Tasks.Task<WorkingDayDto> GetWorkingDayAsync(string day)
        {
            return GetWorkingDayAsync(day, System.Threading.CancellationToken.None);
        }

        /// <param name="cancellationToken">A cancellation token that can be used by other objects or threads to receive notice of cancellation.</param>
        /// <returns>OK</returns>
        /// <exception cref="ApiException">A server side error occurred.</exception>
        public virtual async System.Threading.Tasks.Task<WorkingDayDto> GetWorkingDayAsync(string day, System.Threading.CancellationToken cancellationToken)
        {
            if (day == null)
            ...
            try
            {
                using (var request_ = new System.Net.Http.HttpRequestMessage())
                {
                    ...
                    var urlBuilder_ = new System.Text.StringBuilder();
                    if (!string.IsNullOrEmpty(_baseUrl)) urlBuilder_.Append(_baseUrl);
                    // Operation Path: "api/working-days/{day}"
        ...
        /// <returns>OK</returns>
        /// <exception cref="ApiException">A server side error occurred.</exception>
        public virtual System.Threading.Tasks.Task<WorkingDayDto> PostActiveMergeAsync(string day, System.TimeSpan? start, System.TimeSpan? end)
        {
            return PostActiveMergeAsync(day, start, end, System.Threading.CancellationToken.None);
        }

        /// <param name="cancellationToken">A cancellation token that can be used by other objects or threads to receive notice of cancellation.</param>
        /// <returns>OK</returns>
        /// <exception cref="ApiException">A server side error occurred.</exception>
        public virtual async System.Threading.Tasks.Task<WorkingDayDto> PostActiveMergeAsync(string day, System.TimeSpan? start, System.TimeSpan? end, System.Threading.CancellationToken cancellationToken)
        {
            if (day == null)
                throw new System.ArgumentNullException("day");
            ...
            try
            {
                using (var request_ = new System.Net.Http.HttpRequestMessage())
                {
                    ...
                    var urlBuilder_ = new System.Text.StringBuilder();
                    if (!string.IsNullOrEmpty(_baseUrl)) urlBuilder_.Append(_baseUrl);
                    // Operation Path: "api/working-days/{day}/merges/active"
                    urlBuilder_.Append("api/working-days/");
                    urlBuilder_.Append(System.Uri.EscapeDataString(ConvertToString(day, System.Globalization.CultureInfo.InvariantCulture)));
                    urlBuilder_.Append("/merges/active");
                    urlBuilder_.Append('?');
                    if (start != null)
                    {
        ...
        /// <returns>OK</returns>
        /// <exception cref="ApiException">A server side error occurred.</exception>
        public virtual System.Threading.Tasks.Task<WorkingDayDto> PostInactiveMergeAsync(string day, System.TimeSpan? start, System.TimeSpan? end)
        {
            return PostInactiveMergeAsync(day, start, end, System.Threading.CancellationToken.None);
        }

        /// <param name="cancellationToken">A cancellation token that can be used by other objects or threads to receive notice of cancellation.</param>
        /// <returns>OK</returns>
        /// <exception cref="ApiException">A server side error occurred.</exception>
        public virtual async System.Threading.Tasks.Task<WorkingDayDto> PostInactiveMergeAsync(string day, System.TimeSpan? start, System.TimeSpan? end, System.Threading.CancellationToken cancellationToken)
        {
            if (day == null)
                throw new System.ArgumentNullException("day");
            ...
            try
            {
                using (var request_ = new System.Net.Http.HttpRequestMessage())
                {
                    ...
                    var urlBuilder_ = new System.Text.StringBuilder();
                    if (!string.IsNullOrEmpty(_baseUrl)) urlBuilder_.Append(_baseUrl);
                    // Operation Path: "api/working-days/{day}/merges/inactive"
                    urlBuilder_.Append("api/working-days/");
                    urlBuilder_.Append(System.Uri.EscapeDataString(ConvertToString(day, System.Globalization.CultureInfo.InvariantCulture)));
                    urlBuilder_.Append("/merges/inactive");
                    urlBuilder_.Append('?');
                    if (start != null)
                    {
                        urlBuilder_.Append(System.Uri.EscapeDataString("start")).Append('=').Append(System.Uri.EscapeDataString(ConvertToString(start, System.Globalization.CultureInfo.InvariantCulture))).Append('&');
    ...
    public partial class IntervalDto
    {
    ...
    [System.CodeDom.Compiler.GeneratedCode("NJsonSchema", "14.6.2.0 (NJsonSchema v11.5.2.0 (Newtonsoft.Json v13.0.0.0))")]
    public partial class WorkingDayDto
    {
